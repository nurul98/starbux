...
namespace starbux
{
    public partial class OrderBakery : System.Web.UI.Page
    {
        ...
        private void onload()
        {
            ...
            sqlCommand.Parameters.AddWithValue("@item_type", "Bakery");
        ...
        protected void AddOrder_Click(object sender, EventArgs e)
        {
            ...
            updatecommand2.CommandText = "INSERT INTO Delivery (delivery_ID,customer_username,customer_ID,item_type,item_name,item_quantity,delivery_date,delivery_time,delivery_status,price) VALUES "

                        + " (@delivery_ID,@customer_username,@customer_ID,@item_type,@item_name,@item_quantity,@delivery_date,@delivery_time,@delivery_status,@price)";
            ...
            updatecommand2.Parameters.AddWithValue("@item_type", "Bakery");
            updatecommand2.Parameters.AddWithValue("@item_name", RadioButtonBakery.Text);
            ...
            SqlCommand sqlquantity = new SqlCommand("SELECT * FROM Bakery WHERE bakery_name=@bakery_name", sqlConnection2);
            sqlquantity.Parameters.Clear();

            sqlquantity.Parameters.AddWithValue("@bakery_name", RadioButtonBakery.Text);
            ...
            updatecommand2a.CommandText = "UPDATE Bakery SET sold_quantity=@sold_quantity,sold_price=@sold_price WHERE bakery_name=@bakery_name";
            ...
            updatecommand2a.Parameters.AddWithValue("@bakery_name", RadioButtonBakery.Text);
        ...
        protected void btnDelete_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string Quantity = gvrow.Cells[2].Text;
            DeleteQuantity2.Text = Quantity;
            string Priceitem = gvrow.Cells[3].Text;
        ...
        protected void confirmdelete_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand sqlquantity2 = new SqlCommand("SELECT * FROM Bakery WHERE bakery_name=@bakery_name", sqlConnection2c);
            sqlquantity2.Parameters.Clear();

            sqlquantity2.Parameters.AddWithValue("@bakery_name", DeleteItem2.Text);
            ...
            updatecommand2b.CommandText = "UPDATE Bakery SET sold_quantity=@sold_quantity,sold_price=@sold_price WHERE bakery_name=@bakery_name";
            ...
            updatecommand2b.Parameters.AddWithValue("@bakery_name", DeleteItem2.Text);
        ...
        protected void topitem()
        {
            ...
            SqlCommand sqlCommand = new SqlCommand("SELECT MAX(sold_quantity) AS chose FROM Bakery ", sqlConnection);
            sqlConnection.Open();
            ...
            if (reader2.Read())
            {
                ...
                SqlCommand sqlCommand2 = new SqlCommand("SELECT * FROM Bakery WHERE sold_quantity=@sold_quantity ", sqlConnection2);
                ...
                Top.Text = reader2a["bakery_name"].ToString();
                string getitem = reader2a["bakery_name"].ToString();

                if (String.Compare(getitem.ToString(), "Apple Fritters") == 0)
                {
                    Top1.ImageUrl = "images/applefritter.jpg";
                }
                if (String.Compare(getitem.ToString(), "Apple Muffin") == 0)
                {
                    Top1.ImageUrl = "images/applemufin.jpg";
                }
                if (String.Compare(getitem.ToString(), "Banana Nut Loaf") == 0)
                {
                    Top1.ImageUrl = "images/bananaloaf.jpg";
                }
                if (String.Compare(getitem.ToString(), "Mini Doughnut") == 0)
                {
                    Top1.ImageUrl = "images/minidonut.jpg";
                }
                if (String.Compare(getitem.ToString(), "Blueberry Oat Bar") == 0)
                {
                    Top1.ImageUrl = "images/blueberrybar.jpg";
                }
            }
            else
            {
